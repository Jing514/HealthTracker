...
class ProfileScreen extends StatefulWidget {
  ...
  final void Function(Color) setBottomColor;
  const ProfileScreen({super.key, required this.openBottomNav, required this.setBottomColor});
              ...
              onPressed:
                  isDisableProfile
                      ...
                      : () async {
                        ...
                        widget.setBottomColor(selectedColor);
                        ...
                        if(nameCtrl.text != "" && ageCtrl.text != "" && heightCtrl.text != "" && selectedGender != ""){
